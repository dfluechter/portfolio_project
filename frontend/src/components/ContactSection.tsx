...
export const ContactSection: React.FC = () => {
  return (
    <section id="contact" className="py-20 bg-slate-950/80 border-t border-slate-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <a
            ...
            className="group p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-indigo-500/50 hover:bg-slate-900 transition-all text-center flex flex-col items-center justify-center space-y-3 shadow-sm hover:-translate-y-1"
          >
            ...
            <p className="text-xs text-slate-400">kontakt@dfluechter.de</p>
          </a>
          ...
          >
            ...
            <p className="text-xs text-slate-400">@DominikFluechter</p>
          </a>

          {/* Location Card */}
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 text-center flex flex-col items-center justify-center space-y-3 shadow-sm">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center">
              <MapPin className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-white text-base">Standort</h3>
            <p className="text-xs text-slate-400">Deutschland</p>
          </div>
        </div>
      </div>
    </section>
